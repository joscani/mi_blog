...
* Ahora usamos esos modelos de la siguiente forma, para las observaciones que tengan W=1 utilizamos el modelo  $\hat{\mu}_{1}$,  y para las observaciones con W=0 usamos  el modelo que se ha estimado usando la otra parte de los datos  $\hat{\mu}_{0}$. 
